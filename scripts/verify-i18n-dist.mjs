...
has(de, '<title>Team Calendar — Weniger Admin. Mehr Zeit am Stuhl.</title>', 'DE title');
has(de, 'og:title" content="Team Calendar — Weniger Admin', 'og:title DE tagline');
has(de, 'Weniger Admin.', 'DE hero');
has(de, 'Zeige 81 von 81 Funktionen', 'DE count');
has(de, 'Einen Studio-Tag miterleben', 'DE CTA');
...
has(de, 'Bereitstellung ausstehend', 'DE status label');
